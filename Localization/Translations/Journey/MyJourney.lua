...
local myJourneyLocales = {
    ...
    ["It's about time you embark on your first Journey!"] = {
        ...
        ["enUS"] = "It's about time you embark on your first Journey!",
        ["zhCN"] = "是时候踏上旅程了！",
        ["zhTW"] = "該是你踏上第一次旅程的時候了!",
    ...
    ["Congratulations! You reached %s !"] = {
        ...
        ["enUS"] = "Congratulations! You reached %s !",
        ["zhCN"] = "恭喜你达到了%s！",
        ["zhTW"] = "恭喜! 已達到 %s !",
    ...
    ["You Abandoned the quest %s"] = {
        ...
        ["enUS"] = "You Abandoned the quest %s",
        ["zhCN"] = "你放弃了任务：%s",
        ["zhTW"] = "已放棄任務 %s",
    ...
    ["You Completed the quest %s"] = {
        ...
        ["enUS"] = "You Completed the quest %s",
        ["zhCN"] = "你完成了任务：%s",
        ["zhTW"] = "已完成任務 %s",
    ...
    ["No Note was entered. You must enter a note before submitting."] = {
        ...
        ["enUS"] = "No Note was entered. You must enter a note before submitting.",
        ["zhCN"] = "内容不可为空",
    ...
    ["No Title was entered. You must enter a title before submitting your note."] = {
        ...
        ["enUS"] = "No Title was entered. You must enter a title before submitting your note.",
        ["zhCN"] = "标题不可为空",
    ...
    ["Create an entry in your journal to remember a specific moment. Simply supply a title and description and Questie will remember it for you!"] = {
        ...
        ["enUS"] = "Create an entry in your journal to remember a specific moment. Simply supply a title and description and Questie will remember it for you!",
